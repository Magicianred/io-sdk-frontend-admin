...
class PageDispatcher extends dispatcher_1.Dispatcher {
    constructor(scope, page) {
        ...
        this._page = page;
        page.on(page_1.Page.Events.Close, () => this._dispatchEvent('close'));
        ...
        page.on(page_1.Page.Events.Download, download => this._dispatchEvent('download', { download: new downloadDispatcher_1.DownloadDispatcher(this._scope, download) }));
        ...
        page.on(page_1.Page.Events.RequestFinished, request => this._dispatchEvent('requestFinished', { request: networkDispatchers_1.RequestDispatcher.from(scope, request) }));
...
class BindingCallDispatcher extends dispatcher_1.Dispatcher {
    constructor(scope, name, needsHandle, source, args) {
        super(scope, {}, 'BindingCall', {
            ...
            handle: needsHandle ? new jsHandleDispatcher_1.JSHandleDispatcher(scope, args[0]) : undefined,
        });
