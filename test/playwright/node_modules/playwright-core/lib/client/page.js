...
class Page extends channelOwner_1.ChannelOwner {
    ...
    frame(options) {
        const name = utils_2.isString(options) ? options : options.name;
        const url = utils_2.isObject(options) ? options.url : undefined;
...
class BindingCall extends channelOwner_1.ChannelOwner {
    ...
    async call(func) {
        try {
            ...
            this._channel.resolve({ result: jsHandle_1.serializeArgument(result) });
        }
        catch (e) {
