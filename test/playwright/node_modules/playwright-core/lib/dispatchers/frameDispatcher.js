...
class FrameDispatcher extends dispatcher_1.Dispatcher {
    ...
    async extendInjectedScript(params) {
        return { handle: elementHandlerDispatcher_1.createHandle(this._scope, await this._frame.extendInjectedScript(params.source, jsHandleDispatcher_1.parseArgument(params.arg))) };
    }
}
